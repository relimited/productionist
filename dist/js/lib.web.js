(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Productionist", [], factory);
	else if(typeof exports === 'object')
		exports["Productionist"] = factory();
	else
		root["Productionist"] = factory();
})(this, function() {
...
var _productionist = __webpack_require__(122);

var _productionist2 = _interopRequireDefault(_productionist);

var _contentRequest = __webpack_require__(115);

var _contentRequest2 = _interopRequireDefault(_contentRequest);

var _fetchLoader = __webpack_require__(117);
...
var ProductionistAPI = function () {
  function ProductionistAPI(contentBundleName, contentBundlePath) {
    var nonprobabilistic = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var repeitionPenalty = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var terse = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var verbosity = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;

    _classCallCheck(this, ProductionistAPI);

    this.productionist = new _productionist2.default(contentBundleName, contentBundlePath, !nonprobabilistic, repeitionPenalty, terse, verbosity, _fetchLoader2.default);
  }

  _createClass(ProductionistAPI, [{
    key: 'finalize',
  ...
  return ProductionistAPI;
}();

exports.default = ProductionistAPI;
...
var _grammar = __webpack_require__(118);

var _grammar2 = _interopRequireDefault(_grammar);

var _expressibleMeaning = __webpack_require__(116);
...
var FetchLoader = function () {
  ...
  _createClass(FetchLoader, null, [{
    ...
    value: function loadGrammar(path) {
      ...
      }).then(function (grammarObj) {
        return new _grammar2.default(grammarObj); //wrap the anon JSON object as a Grammar
      });
    }
    ...
    value: function loadExpressibleMeanings(path, idToTag) {
      return fetch(path).then(function (response) {
        ...
        var _loop = function _loop(line) {
          ...
          try {
            for (var _iterator2 = allPathsStr.split("|")[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
              var pathStr = _step2.value;
        ...
        try {
          for (var _iterator = fileLines[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var _nonterminalSymbol = __webpack_require__(119);
...
var _productionRule = __webpack_require__(121);
...
var _output = __webpack_require__(120);
