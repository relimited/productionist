...
class Productionist {
  constructor(contentBundleName, contentBundleDirectory, probabilisticMode, repetitionPenaltyMode, terseMode, verbosity){
    ...
    if(contentBundleDirectory.endsWidth("/")){ //strip trailing slash.  [Port]: might shift this to a URI
  ...
  finalizeProductionist(){
    ...
    return this.loadGrammar(`${this.grammarFileLocation}/${this.contentBundleName}.grammar`)
      .then(grammar => {
        ...
        return this.loadTrie(`${this.grammarFileLocation}/${this.contentBundleName}.marisa`)
      })
      .catch(() => {
        this.trie = null;
        ...
        return this.loadExpressibleMeanings(`${this.grammarFileLocation}/${this.contentBundleName}.meanings`);
      })
      .then(meanings => {
